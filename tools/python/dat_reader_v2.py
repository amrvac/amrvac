...
if __name__ == '__main__':
    # Example of how these routines can be used
    parser = argparse.ArgumentParser(
        description='''Read .dat files of MPI-AMRVAC simulations''')
    parser.add_argument('dat_file', type=argparse.FileType('rb'),
                        help='MPI-AMRVAC .dat file to read')

    args = parser.parse_args()
    hdr = get_header(args.dat_file)
    d = get_uniform_data(args.dat_file)

...
!=============================================================================
 ...
 15            continue
         ...
         if(abs(hnext).lt.hmin) call stop&
...
!CU    USES derivs
      ...
      PARAMETER (A2=.2d0,A3=.3d0,A4=.6d0,A5=1.d0, A6=.875d0,B21=.2d0,B31=3.d0&
         /40.d0,B32=9.d0/40.d0,B41=.3d0,B42=-.9d0,B43=1.2d0,B51=&
         -11.d0/54.d0,B52=2.5d0,B53=-70.d0/27.d0,B54=35.d0/27.d0,B61=1631.d0&
         ...
         /27648.d0,DC3=C3-18575.d0/48384.d0,DC4=C4-13525.d0/55296.d0,DC5=&
         -277.d0/14336.d0,DC6=C6-.25d0)
      do 11 i=1,n

...
INTEGER,PARAMETER:: ndim=1, ndir=3
...
common /nodalr/     rnode(rnodehi,ngridshi), rnode_sub(rnodehi,ngridshi),&
    ...
    dt_grid(ngridshi), dxlevel(ndim)
common /nodali/     node(nodehi,ngridshi), node_sub(nodehi,ngridshi),&
    nbufferx1, mxnest, dixB, levmin, levmax, levmax_sub
...
COMMON /CHAR/ typecourant,typeresid,typeadvance,typelow1,typelimited,&
   ...
   typelimiter,typegradlimiter,typeprolonglimit,typeentropy,typetvd,typetvdlf,&
...
COMMON /LOGI/ time_accurate, addmpibarrier,tmaxexact,treset,itreset,&
   ...
   sourceimpl,sourceimplcycle,conduction,TCsaturate,energyonly,loglimit,&
   logflag,flathllc,flatcd,flatsh,flatppm,ssplitdust,ssplitdivb,ssplitresis,&

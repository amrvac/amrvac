...
INTEGER,PARAMETER:: sig0_=neqpar+1, lor_=neqpar+2, &
     b_=neqpar+3, eta_=neqpar+4, vext_=neqpar+5, rhoe_=neqpar+6, &
     theta0_=neqpar+7, flfac_=neqpar+8, flfacNeighbor_=neqpar+9, &
     m_=neqpar+10, DeltaRho_=neqpar+11, Mext_=neqpar+12, ri_=neqpar+13, &
     ds_=neqpar+14, nspecialpar=14

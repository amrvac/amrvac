...
DOUBLE PRECISION,PARAMETER:: zero=0D0,one=1D0,two=2D0,half=0.5D0,quarter=0.25D0,third=0.33333333333d0
...
COMMON, INTEGER:: it,itmax,itmin,slowsteps
...
COMMON, CHARACTER*131 :: typedimsplit,typeaxial,typepoly
...
COMMON, DOUBLE PRECISION:: divbdiff,smallp,smallrho,amr_wavefilter(nlevelshi)
...
COMMON, LOGICAL:: usecovariant,nocartesian
...
! accretion related variables (for accreting binary problem)
COMMON, DOUBLE PRECISION :: acc_mass_mype,acc_mass_global,acc_mass_tot

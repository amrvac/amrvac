...
first_magnetogram = '2015-06-17T01:14:00'
last_magnetogram = '2015-07-09T23:04:00'
...
for i, data in enumerate(dataset):
    ...
    print (vr_index, n_index, temp_index, br_index)
...
SPACING {} {} 2.
ORIGIN {} {}  0
POINT_DATA {}""".format(nlat,nlon,n_time,dlat,dlon, bottom, left, nlat*nlon*n_time)

...
113    close(unitpar)
  ...
  subroutine initial_conditions(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    double precision :: T_in, E_in, rr(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), bb, temp(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3)

    integer :: ii, ix1,ix2,ix3
...
!
    ...
    do ix2 = ixOmin2,ixOmax2
      do ix3 = ixOmin3,ixOmax3
        w(:,ix2,ix3,mom(2)) = 1.d-1*dsin(x(:,ix2,ix3,1)-1.d0)*dcos(6*x(:,ix2,&
           ix3,2))* w(:,ix2,ix3,rho_)
        w(:,ix2,ix3,mom(3)) = 1.d-1*dsin(x(:,ix2,ix3,1)-1.d0)*dcos(6*x(:,ix2,&
           ix3,2))* w(:,ix2,ix3,rho_)
      enddo
    enddo
...
8765 CLOSE(1)
  ...
  subroutine boundary_conditions(qt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    double precision :: kappa(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
    ...
    case(1)
      ...
      do ix1 = ixBmax1-1,ixBmin1,-1
        w(ix1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,rho_) = dexp(2*dlog(w(ix1+1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,rho_)) - dlog(w(ix1+2,&
      ...
      do ix1 = ixBmax1,ixBmin1,-1
        w(ix1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(1)) = w(ix1+1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(1))
        w(ix1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(2)) = w(ix1+1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(2))
        w(ix1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(3)) = w(ix1+1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(3))
      enddo

      !> Floor value for negative inflow
      where(w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,&
         mom(1)) .lt. -0.05d0*rho_bound)
       w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,&
          mom(1)) = -0.05d0*rho_bound
      endwhere

      !> Ceil value for positive outflow
      where(w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,&
         mom(1)) .gt. 0.1d0*rho_bound)
       w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,&
          mom(1)) = 0.1d0*rho_bound
      endwhere
      ...
      where (F_adv(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ...
         ixBmin3:ixBmax3)) F_adv(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3) = 0.d0
      where (F_adv(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3) .le. 0.d0) F_adv(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3) = 0.d0
      ...
      do ix1 = ixImin1,ixImax1
        do ix2 = ixBmin2,ixBmax2
          do ix3 = ixBmin3,ixBmax3
            Local_gradE(ix1,ix2,ix3) = -(F_bound-F_adv(ixBmax1,ix2,&
               ix3))/w(nghostcells+1,ix2,ix3,i_diff_mg)
      ...
      do ix1 = ixBmax1,ixBmin1,-1
        do ix2 = ixBmin2,ixBmax2
          do ix3 = ixBmin3,ixBmax3
            w(ix1,ix2,ix3,r_e) = min(2.d0,w(ix1+2,ix2,ix3,r_e)) + (x(ix1,ix2,&
               ix3,1)-x(ix1+2,ix2,ix3,1))*Local_gradE(ix1+1,ix2,ix3)
          enddo
        enddo
      enddo
      ...
      if (rhd_energy) then
        temp(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
           ixBmin3:ixBmax3) = (w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
           ixBmin3:ixBmax3,r_e)*unit_pressure/const_rad_a)**&
           0.25d0/unit_temperature
        w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,&
           e_) = w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,&
           rho_)*temp(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
           ixBmin3:ixBmax3)/(rhd_gamma-1.d0) + half*(w(ixBmin1:ixBmax1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(1))**2+w(ixBmin1:ixBmax1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(2))**2+w(ixBmin1:ixBmax1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,mom(3))**2)/w(ixBmin1:ixBmax1,&
           ixBmin2:ixBmax2,ixBmin3:ixBmax3,rho_)
      endif
   ...
   case(2)
      ...
      call get_kappa_OPAL(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,w,x,kappa)

      kappa_out = sum(kappa(ixImax1-nghostcells,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3))/((ixBmax2-ixBmin2)*(ixBmax3-ixBmin3))
      ...
      Local_tauout(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3) = kappa_out*w(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3,rho_)*R_star**2/(3*x(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3,1))
      Local_Tout(ixBmin1:ixBmax1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3) = F_bound/StefBoltz*(3.d0/4.d0*Local_tauout(&
         ixBmin1:ixBmax1,ixBmin2:ixBmax2,ixBmin3:ixBmax3))**0.25d0

      T_out = sum(Local_Tout(ixBmin1,ixBmin2:ixBmax2,&
         ixBmin3:ixBmax3))/((ixBmax2-ixBmin2)*(ixBmax3-ixBmin3))
...
!      T_out = max(4.2d4/unit_temperature, T_out)
  ...
  subroutine Fix_pressure(level,qt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
     ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x)
    use mod_global_parameters
    ...
    !if (any(press(ixO^S) .lt. 0.d0)) then
      mean_p = max(sum(pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3))/(block_nx1*block_nx2),small_pressure)
      where (pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) .le. small_pressure)
    ...
    where ((pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ...
       rho_)*unit_temperature) .gt. 1.d6)
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         e_) = 1.d6/unit_temperature*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,rho_)/(rhd_gamma - 1) + 0.5d0 * sum(w(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3, mom(:))**2,&
          dim=ndim+1)/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_)
    end where

    where (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,r_e) .gt. 0.5d0)
        w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,r_e) = 0.5d0
    end where
  ...
  subroutine set_gravitation_field(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    gravity_field(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,:) = 0.d0
    gravity_field(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
       1) = -const_G*mass/radius(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3)**2*(unit_time**2/unit_length)
  ...
  subroutine PseudoPlanar(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       ...
       mom(3)) !> OK
    if (rhd_energy) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       e_) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       e_) + qdt*ppsource(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,e_) !> OK
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,r_e) = w(ixOmin1:ixOmax1,&
       ...
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,r_e) !> TROUBLEMAKER

    if (.not. Cak_in_D) then
      if (read_cak_table) then
        call get_kappa_CAK2(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
           ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,wCT,x,k_cak)
      else
        call get_kappa_CAK(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
           ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,wCT,x,k_cak)
      endif
      ...
      if (fixed_lum) then
        ...
        w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
           ...
           ixOmin3:ixOmax3,1)**2)/const_c*k_cak(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,ixOmin3:ixOmax3)*unit_velocity
        if (rhd_energy) then
          w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
             e_) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
        ...
        w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
           mom(1)) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
           mom(1)) + qdt*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
           rho_)*rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
           1)/const_c*k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)*unit_velocity
        if (rhd_energy) then
          w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
             e_) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
             e_) + qdt*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
             mom(1))*rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
             1)/const_c*k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             ixOmin3:ixOmax3)*unit_velocity
        endif
      endif
  ...
  subroutine get_dt_cak(w,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    if (read_cak_table) then
      call get_kappa_CAK2(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,k_cak)
    else
      call get_kappa_CAK(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,k_cak)
    endif
    ...
    if (fixed_lum) then
      ...
      dt_cak = courantpar*minval(dsqrt(dxlevel(1)/(L_bound/(4*dpi*x(&
         ...
         1)**2)/const_c*k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*unit_velocity -const_G*mass/radius(ixImin1:ixImax1,&
         ixImin2:ixImax2,ixImin3:ixImax3)**2*(unit_time**2/unit_length))))
    else
      !> Local flux
      ...
      dt_cak = courantpar*minval(dsqrt(dxlevel(1)/abs(rad_flux(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3,1)/const_c*k_cak(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3)*unit_velocity &
         -const_G*mass/radius(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)**2*(unit_time**2/unit_length))))
    endif
  ...
  subroutine PseudoPlanarSource(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       rdir) !+ half*block%dx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,rdir)
    ...
    source(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       ...
       ixOmin3:ixOmax3) + w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       rho_)*v(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       tdir)**two/radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)
  ...
  subroutine OPAL_and_CAK(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    double precision :: OPAL(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3),&
        CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)

    !> Get OPAL opacities by reading from table
    call get_kappa_OPAL(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,OPAL)

    !> Get CAK opacities from gradient in v_r (This is maybe a weird approximation)
    if (Cak_in_D) then
      if (read_cak_table) then
        call get_kappa_CAK2(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
           ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,CAK)
      else
        call get_kappa_CAK(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
           ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,CAK)
      endif
    else
      CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = 0.d0
    endif

    !> Add OPAL and CAK for total opacity
    kappa(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = OPAL(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) + CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)

    where(kappa(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) .ne. kappa(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3))
      kappa(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = kappa_e
    endwhere

  end subroutine OPAL_and_CAK


  subroutine get_kappa_OPAL(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
     ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,kappa)
...
!    endif
    ...
    where(kappa(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) .lt. kappa_e)
      kappa(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = kappa_e
    endwhere
  ...
  subroutine get_kappa_CAK(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
     ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,kappa)
    use mod_global_parameters
    use mod_opal_opacity
    use mod_fld
    ...
    gradv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = abs(gradv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3))

    xx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = &
       1.d0-xprobmin1/x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,1)

    alpha(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = cak_a

    where (xx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) .le. cak_x0)
      alpha(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = cak_base
    elsewhere (xx(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) .le. cak_x1)
      alpha(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = cak_base + (cak_a - cak_base)*(xx(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3) - cak_x0)/(cak_x1 - cak_x0)
    endwhere

    kappa(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = kappa_e*cak_Q/(1-alpha(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3)) *(gradv(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3)*unit_velocity/(w(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_)*const_c*cak_Q*kappa_e))**&
       alpha(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)

    if (x(ixImax1,nghostcells, nghostcells,1) .ge. xprobmax1) then
      kappa(ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = kappa(ixOmax1-1,&
    ...
    do ix1=ixOmin1,ixOmax1
     ...
     do ix3=ixOmin3,ixOmax3
      ...
      kappa(ix1,ix2,ix3) = min(50*kappa_e,kappa(ix1,ix2,ix3))
    enddo
     enddo
     enddo
  ...
  subroutine ceil_diffcoef(w, wCT, x, ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
     ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3)
    use mod_global_parameters
    integer, intent(in)          :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3
    ...
    where (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       ...
       ixOmin3:ixOmax3,i_diff_mg) = 1.5d3

    where (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_diff_mg) .lt. 1.d-2) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3,i_diff_mg) = 1.d-2
...
enddo
  ...
  subroutine update_extravars(igrid,level,ixImin1,ixImin2,ixImin3,ixImax1,&
    ...
    double precision                   :: g_rad(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3), big_gamma(ixImin1:ixImax1,&
    ...
    double precision                   :: kappa(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3), OPAL(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3), CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3),&
        CAK2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)
    double precision                   :: vel(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), gradv(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3)
    double precision                   :: rad_flux(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,1:ndim), Lum(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3)
    double precision                   :: pp_rf(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3), lambda(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3), fld_R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3), gradOE(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)
    integer                            :: idim
    double precision :: radius(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3)
    ...
    if (rhd_energy)    call rhd_get_tgas(w, x, ixImin1,ixImin2,ixImin3,ixImax1,&
       ixImax2,ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, Tgas)
    ...
    call get_kappa_OPAL(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,OPAL)
    call get_kappa_CAK(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
       ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,CAK)
    call get_kappa_CAK2(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
       ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,w,x,CAK2)

    g_rad(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = (OPAL(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)+CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3))*rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3,1)/(const_c/unit_velocity)
    g_grav(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = const_G*mass/radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)**2*(unit_time**2/unit_length)
    big_gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = g_rad(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)/g_grav(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)

    vel(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) = w(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3,mom(1))/w(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3,rho_)
    call gradient(vel,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,&
       ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,1,gradv)

    pp_rf(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = two*rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
    ...
    Lum(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = &
       4*dpi*rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       1)*(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       1)*unit_length)**2*unit_radflux/L_sun

    call gradientO(w(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,r_e),x,&
       ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,&
       ixOmax1,ixOmax2,ixOmax3,1,gradOE,nghostcells)

    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_v1) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       mom(1))/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_v2) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       mom(2))/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_v3) = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       mom(3))/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_)
    if (rhd_energy) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_p) = (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       e_) - 0.5d0 * sum(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
        mom(:))**2, dim=ndim+1) / w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3, rho_)) *(rhd_gamma - 1)

    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_Trad) = Trad(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)*unit_temperature
    if (rhd_energy) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_Tgas) = Tgas(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)*unit_temperature
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_Mdot) = 4*dpi*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       mom(1))*radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)**2 *unit_density*unit_velocity/M_sun*year
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_Opal) = OPAL(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)/kappa_e
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_CAK) = CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)/kappa_e
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_CAK2) = CAK2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)/kappa_e
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_lambda) = lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_Edd) = lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) + lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)**2 * fld_R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)**2
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_Gamma) = big_gamma(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_Lum) = Lum(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_F1) = rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       1)/F_bound
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_F2) = rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       2)/F_bound
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_F3) = rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       3)/F_bound
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       i_gradE) = gradOE(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)

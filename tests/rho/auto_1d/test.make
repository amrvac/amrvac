...
ball_1d_ssprk54_fd_mp5.log ball_1d_rev_1step_tvd.log				\
...
ball_1d_rev_1step_tvd.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/1step_tvd.par
ball_1d_rev_2step_tvdlf_mm.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/2step_tvdlf_mm.par
ball_1d_rev_2step_tvdmu_al.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/2step_tvdmu_al.par
ball_1d_rev_3step_hll_cada.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/3step_hll_cada.par
ball_1d_rev_4step_hll_mc.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/4step_hll_mc.par
ball_1d_rev_4step_hllc_ko.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/4step_hllc_ko.par
ball_1d_rev_rk4_tvdlf_cada.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/rk4_tvdlf_cada.par
ball_1d_rev_ssprk43_fd_mp5.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/ssprk43_fd_mp5.par
ball_1d_rev_ssprk54_fd_mp5.log: PARS = ball_1d.par rev.par $(SCHEME_DIR)/ssprk54_fd_mp5.par

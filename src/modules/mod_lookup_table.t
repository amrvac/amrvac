...
module mod_lookup_table
  ...
  public :: LT2_get_range_col    ! Interpolate one column
  public :: LT2_get_range_col_at_loc ! Get one column at location
  ...
  public :: LT3_get_range_col    ! Interpolate one column
  public :: LT3_get_range_col_at_loc ! Get one column at location
...
contains
  ...
  !> Get the value of a single column at x
  function LT2_get_range_col(my_lt, col_ix_l, col_ix_h, x1, x2) result(col_value)
    type(LT2_t), intent(in) :: my_lt
    integer, intent(in)     :: col_ix_l, col_ix_h
    real(dp), intent(in)    :: x1, x2
    real(dp)                :: col_value(my_lt%n_cols)
    type(LT2_loc_t)         :: loc

    loc       = LT2_get_loc(my_lt, x1, x2)
    col_value = LT2_get_range_col_at_loc(my_lt, col_ix_l, col_ix_h, loc)
  end function LT2_get_range_col

  !> Get the value of a single column at a location
  function LT2_get_range_col_at_loc(my_lt, col_ix_l, col_ix_h, loc) result(col_value)
    type(LT2_t), intent(in)     :: my_lt
    integer, intent(in)         :: col_ix_l, col_ix_h
    type(LT2_loc_t), intent(in) :: loc
    integer                     :: ix(2)
    ...
    do col_ix = col_ix_l, col_ix_h
       col_value(col_ix) = sum(w * my_lt%rows_cols(ix(1):ix(1)+1, &
            ix(2):ix(2)+1, col_ix))
    end do
  end function LT2_get_range_col_at_loc
  ...
  !> Get the value of a single column at x
  function LT3_get_range_col(my_lt, col_ix_l, col_ix_h, x1, x2, x3) result(col_value)
    type(LT3_t), intent(in) :: my_lt
    integer, intent(in)     :: col_ix_l, col_ix_h
    real(dp), intent(in)    :: x1, x2, x3
    real(dp)                :: col_value(my_lt%n_cols)
    ...
    loc       = LT3_get_loc(my_lt, x1, x2, x3)
    col_value = LT3_get_range_col_at_loc(my_lt, col_ix_l, col_ix_h, loc)
  end function LT3_get_range_col

  !> Get all the value of a single column at a location
  function LT3_get_range_col_at_loc(my_lt, col_ix_l, col_ix_h, loc) result(col_value)
    type(LT3_t), intent(in)     :: my_lt
    integer, intent(in)         :: col_ix_l, col_ix_h
    type(LT3_loc_t), intent(in) :: loc
    integer                     :: ix(3)
  ...
  end function LT3_get_range_col_at_loc

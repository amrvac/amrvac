...
contains
  ...
  subroutine read_data_init()
    ...
    if(usr_filename/='')then
       ...
       do ivar = 1,bc%n_variables
          ...
          lt_3d(ivar) = LT3_create_from_data(bc%origin(1:ndim), xmax(1:ndim),&
              bc%values(:, :, :, ivar:ivar))
  ...
  subroutine read_data_set(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
     ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,x,val,nval)
    use mod_global_parameters
    integer, intent(in)             :: ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3, ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, nval
    double precision, intent(in)    :: x(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3,1:ndim)
    double precision, intent(out)   :: val(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3,1:nval)
    integer                         :: ival
    ...
    do ival=1,nval
       val(ixOmin1:ixOmax1, ixOmin2:ixOmax2, ixOmin3:ixOmax3,&
           ival) = read_data_get_3d(ival, x(ixOmin1:ixOmax1, ixOmin2:ixOmax2,&

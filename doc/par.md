...
default is `ghostcell_comm_batched=F`; set it to `T` to enable batching. In
large-scale MHD tests, the original
...
difference with batching enabled. The default batch size is 64.

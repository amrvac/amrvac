...
and hence suffice for visualization.
...
However, in many instances, one would like to use data formats that are directly readable by some of the
...
*U*nstructured data format) directly readable by

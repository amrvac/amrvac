...
Not all methods are available or meaningful for all physics modules. In fact,
...
number of ghost cell layers and odd number of ghost layers for some slope limiters, e.g. `mp5`, is added by one to become even.
